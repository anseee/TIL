...
- 언어나 기술명으로 폴더를 만듭니다. (root에 문서를 만들지 않습니다.)
- 파일명은 영어로 작성합니다.

## 로컬에서 띄우기
[gollum](https://github.com/gollum/gollum), [pow](http://pow.cx/) 와 [anvil](http://anvilformac.com/)을 사용합니다.
...
### 사용법
다음 설정을 하고 브라우저에서 [http://til.wiki.dev/](http://til.wiki.dev/)로 접속합니다.
