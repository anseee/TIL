...
#### 문자열? 그런 달달한 것이 남아있긴 한가? (한상곤)
*
#### Django로 쇼핑몰 만들자 (정경업)
*
#### Deep Learning with Python & TensorFlow (Ian Lewis)
*
#### GPU Acceleration of a Global Atmospheric Model by Python combining with CUDA (김기환)
*
#### 나의 사진은 내가 지난 과거에 한 일을 알고 있다 (최규민)
*

#### Python, VTK를 만나다! - Python, VTK를 활용한 3차원 볼륨 데이터의 시각화 및 활용 (임성준)
*
#### TOROS: Python Framework for Recommender System (김광섭)
*
#### Creating AI chat bot with Python 3 and Tensorflow (신정규)
*
#### Django, Flask 고민없이 개발하고 서비스하는 PaaS, IBM Bluemix (공진기)
*
#### Introduction to deep learning for machine vision tasks using Keras. (Michael Amy)
*
#### Regular expression [A-Z]+ (양민지)
*
#### 뉴스를 재미있게 만드는 방법; 뉴스잼 (김경훈)
*
#### Python으로 IoT, 인지(Cognitive), 머신러닝 삼종세트 활용하기 (김영욱)
*
#### 파이썬을 활용한 똑똑한 주식투자 (시스템 트레이딩) (김대현)
*
#### Introduction into aiohttp (Andrew Svetlov)
*
#### Basic Statistics with Python (Aris Budi Wibowo)
*
#### The PSF and our community (김영근)
*
#### Boost Maintainability (Mosky Liu)
*
#### 파이썬으로 광고 효과 측정하기 (오재혁)
*
#### You Might Not Want Async (Tzu-ping Chung)
*
#### Python + Spark, 머신러닝을 위한 완벽한 결혼 (안명호)
*
#### Demystifying Python Method Resolution Order (Amit Kumar)
*
#### Daily Continuous Deployment를 위한 custom CLI 개발 및 AWS Elastic Beanstalk에 적용하기 (한종원)
*
#### High-performance Networking with Python (김준기)
*
#### PyLadies and PyGents (신예지)
*
#### 기계학습을 활용한 게임 어뷰징 검출 (김정주)
*
